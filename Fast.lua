...
function Dev(msg) 
ok = false/9+8
local list = {Sudo_Id,5566924539,6298482218,6018314315}
...
send(data.chat_id,data.id,"↯ اهلا بك في صانع بوتات ميوزك سورس ستورم \n↯ مطور البوت @G5_7B","html",true, false, false, true, reply_markup)
return false 
end
---making user
